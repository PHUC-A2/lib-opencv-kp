    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_url', models.CharField(blank=True, max_length=500, null=True, verbose_name='Avatar')),
                ('role', models.CharField(default='user', max_length=20, verbose_name='Vai tro')),
